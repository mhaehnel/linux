...
//#include <../arch/arm/mach-s3c24xx/include/mach/gpio.h>
#include <../arch/arm/mach-s3c24xx/include/mach/regs-gpio.h>
...
static	DEVICE_ATTR(pwm_enable, 0664, show_pwm_status, set_pwm_enable);
...
static	DEVICE_ATTR(fan_mode, 0664, show_fan_mode, set_fan_mode);
...
static	DEVICE_ATTR(pwm_duty, 0664, show_pwm_duty, set_pwm_duty);
...
static	DEVICE_ATTR(temp_levels, 0664, show_temp_levels, set_temp_levels);
...
static	DEVICE_ATTR(fan_speeds, 0664, show_fan_speeds, set_fan_speeds);
...
//MH:BUG		s5p_gpio_set_drvstr(fan->pdata->pwm_gpio, S5P_GPIO_DRVSTR_LV4);
